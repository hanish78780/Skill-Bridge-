    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8 animate-fade-in">
            <div className="mb-8 text-center">
                ...
                <p className="text-gray-600">Discover skilled developers for your next project</p>
            </div>
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col md:flex-row gap-4 mb-8">
                ...
                <div className="w-full md:w-48 relative">
                    ...
                    <select
                        className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg appearance-none focus:ring-2 focus:ring-indigo-500 outline-none"
                        value={availability}
                            ...
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">{user.title || 'Developer'}</p>
                                    </div>
                                </div>
